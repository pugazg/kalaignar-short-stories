...
|---:|---|---|---|---|
| 1 | `மன்னனும் குருவியும்!` | 5 → upper 6 | canonical | **PASS** |
| 2 | `அராபியக் கதை` | lower 6 → upper 7 | 1987 witness-local | **PASS** |
| 3 | `தென்னை மரத்தில் புல்` | lower 7 | canonical | **PASS** |
| 4 | `நாராயணா ! நாராயணா !` | 8 → 9 → upper 10 | canonical | **PASS** |
| 5 | `துறவியும் சீடர்களும்` | lower 10 → 11 → upper 12 | canonical | **PASS** |
| 6 | `மூளி மூக்குக்காரன்` | lower 12 → upper 13 | canonical | **PASS** |
| 7 | `சொர்க்கத்திற்குச் சென்றுவந்த அழகி!` | lower 13 → 14 → upper 15 | canonical | **PASS** |
| 8 | `புத்தர் உணர்த்திய உண்மை` | lower 15 → 16 → 17 → upper 18 | canonical | **PASS** |
| 9 | `கஜினி முகமதுவும் கவிஞர் பார்டோசியும்` | lower 18 → 19 → upper 20 | canonical | **PASS** |
| 10 | `இரு நிழல்கள்` | lower 20 → 21 → 22 → upper 23 | canonical; legacy slug retained | **PASS** |
| 11 | `குருவி ராமேஸ்வரம்` | lower 23 → upper 24 | 1987 witness-local | **PASS** |
| 12 | `சாமியாரும் பூக்காரியும்` | lower 24 → upper 25 | canonical | **PASS** |
| 13 | `ஹஜ்ரத் அலியும் யூதனும்` | lower 25 → 26 → upper 27 | canonical | **PASS** |
| 14 | `புகழேந்திப் புலவர் கதை` | lower 27 → 28 | canonical | **PASS** |
| 15 | `மன மாற்றம்` | 29 → 30 | canonical | **PASS** |
| 16 | `குறிக்கோள்` | 31 → upper 32 | canonical | **PASS** |
| 17 | `பாலும் தண்ணீரும்` | lower 32 → 33 → upper 34 | canonical | **PASS** |
| 18 | `ஜெயத்ரதனின் வீழ்ச்சி` | lower 34 → 35 → 36 → upper 37 | canonical | **PASS** |
