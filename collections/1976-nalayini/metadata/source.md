# Source metadata — 1976 `நளாயினி`

## Identity

- filename: `TVA_BOK_0065574_நளாயினி_1976.pdf`
- byte size: **164,748,566**
- PDF scan count: **78**
- printed collection title: **நளாயினி**
...
3. `புரட்சிப் படம்` — **19–24**;
4. `நாட்டிய கலாராணி` — **25–46**;
5. `விஷம் இனிது` — **47–55**;
6. `பாலைவன ரோஜா` — **56–62**;
7. `அய்யோ ராஜா!` — **63–72**;
8. `மானம்` — **73–78**.
...
- aged paper / uneven background tone;
