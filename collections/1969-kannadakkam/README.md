...
| 2 | `நெருப்பு` | 11–24 | 10–23 | `stories/neruppu/` — **new canonical active** | **P2 Stage 3 COMPLETE / PASS 5/5; P2 Stage 4 NEXT** |
...
Overall `நெருப்பு`: Stages 1–3 **10/14**; Stage 4 **5/14**; verified **5/14**; needs-review **5/14**; not-started **4/14**.

## Exact next activity

Process **`நெருப்பு` P2 Stage 4 — final independent source check**, scans **16–20 / printed pages 15–19**.
