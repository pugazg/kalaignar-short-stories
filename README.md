...
- **1950 `வாழமுடியாதவர்கள்` — ACTIVE / INTAKE COMPLETE:** source registered at [`collections/1950-vazha-mudiyathavargal/`](collections/1950-vazha-mudiyathavargal/README.md); **6/6** works mapped, all route to existing canonicals as earlier witnesses. Source scans **14–15** are severely physically damaged; missing 1950 text must not be reconstructed. Exact next: Story 1 `வாழ முடியாதவர்கள்`, scans **6–15 / printed 5–14** — **10 source pages**.
- **1953 `தப்பிவிட்டார்கள்` — QUEUED / INTAKE COMPLETE:** source registered at [`collections/1953-thappivittargal/`](collections/1953-thappivittargal/README.md); **4/4** works mapped: 3 existing-canonical witnesses + **1 new-canonical candidate, `விலையால் வாங்கலையோ`**. Begin only after the active 1950 collection unless the user redirects.
- **1956 `தாய்மை` — CLOSED FOR ALL SOURCE-VISIBLE WITNESS PAGES:** `தாய்மை` **16/16 PASS**; `ஆட்டக் காவடி` **11/11 PASS**; `நடுத்தெரு நாராயணி` **26/26 PASS**; `அரும்பு` **28/28 physical scans reviewed / PASS for all visible pages**. Printed pages **80–81** remain absent from the supplied 1956 PDF and were not reconstructed. Canonical Tamil/English were not changed from witness evidence. Separate recheck queue retained: **1** candidate for `ஆட்டக் காவடி`, **4** for `நடுத்தெரு நாராயணி`, **0** for `அரும்பு`. No automatic next activity.
