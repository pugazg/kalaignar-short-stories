...
- **1953 `நாடும் நாடகமும்` — ACTIVE:** all five body units remain in this repository. Retained work 1 `நாடும் நாடகமும் (ஆசிரியர் பேசுகிறார்)` Batch 1 scans **5–9 / printed 1–5** has completed a fresh **word-by-word visual fidelity re-audit** with **14 additional source-proven corrections**. Scans **5–8 are RE-VERIFIED**; scan **9 recoverable text PASS**, with the single physically obliterated span still `BLOCKED` and no guessed reconstruction. Exact next: **Batch 2 Stage 1 first-pass transcription, scans 10–14 / printed 6–10**. `தெருக்கூத்து` remains next after this work closes.
