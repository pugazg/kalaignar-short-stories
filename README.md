...
- **1956 `தாய்மை` — ACTIVE / EARLIER-WITNESS ANTHOLOGY:** `தாய்மை` witness **CLOSED / PASS 16/16**; `ஆட்டக் காவடி` witness **CLOSED / PASS 11/11** with one canonical-recheck candidate still open (`நாளெல்லாம்` vs current `நாவெல்லாம்`); cross-repo `நடுத்தெரு நாராயணி` witness in `pugazg/kalaignar-novels` is **IN PROGRESS 5/26** through scans **34–38 / printed 32–36**, with one recheck candidate (`கர்வமடக்கும்` vs current `கருவமடக்கும்`). Printed pages **80–81** remain absent. User batching rule: **10 source pages per iteration**; exact next = scans **39–48 / printed 37–46**.
