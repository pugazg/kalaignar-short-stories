...
- **1950 `வாழமுடியாதவர்கள்` — CLOSED / WITNESS WORKFLOW COMPLETE:** source registered at [`collections/1950-vazha-mudiyathavargal/`](collections/1950-vazha-mudiyathavargal/README.md); **6/6** visible witness stories dispositioned. Physical damage remains documented; missing 1950 text was not reconstructed.
- **1953 `தப்பிவிட்டார்கள்` — CLOSED / PASS:** source and English workflow fully closed; **4/4** works dispositioned, including new canonical `விலையால் வாங்கலையோ`.
- **1953 `நாடும் நாடகமும்` — ACTIVE:** all five body units remain in this repository. Retained work 1 `நாடும் நாடகமும் (ஆசிரியர் பேசுகிறார்)` Batch 1 scans **5–9 / printed 1–5** is now **CLOSED / VERIFIED 5/5** after the word-by-word re-audit and a user-guided targeted scan-9 recheck, with **19 final source-proven corrections**. The former scan-9 hold is resolved; no guessed reconstruction remains. Batch 2 scans **10–14 / printed 6–10** Stage 1 is **COMPLETE 5/5** with five `needs-review` page records and **3 explicit unresolved first-pass spans on scan 13**; guessed readings remain 0. Exact next: **Batch 2 Stage 2 visual text-fidelity audit, scans 10–14 / printed 6–10**. `தெருக்கூத்து` remains next after this work closes.
- **1956 `தாய்மை` — CLOSED FOR ALL SOURCE-VISIBLE WITNESS PAGES:** visible witness processing complete; printed pages **80–81** remain absent and were not reconstructed.
- **1958 `தேனலைகள்` — DEFERRED / INTAKE COMPLETE:** [`collections/1958-thenalaigal/`](collections/1958-thenalaigal/README.md) remains registered with **12/12** story ranges mapped; transcription **NOT STARTED**. Do not auto-resume.
...
- **Periodical source onboarding — ACTIVE (15 Sep 2026):** four user-supplied magazine sources registered. `பனங்குலை` 1977 periodical is routed as an additional witness and **CLOSED / PASS 2/2**; new canonicals `சீரழித்த சிரிப்பு!`, `மதுரைச் செலவு`, and `கொன்று வருக!` are activated with source intake complete and Stage 1 pending. Exact next: `சீரழித்த சிரிப்பு!` Stage 1, scans 101–102.
...
| [`புகழேந்தி`](stories/pugazhendhi/README.md) | **2026 dual-gate CURRENT PASS — Gate A 6/6 + Gate B 6/6; 9 repairs; 0 unresolved** | **PASS — synchronized; English re-audit E1 + E2 + E3 + E4 + E5 PASS** |
| [`நளாயினி`](stories/nalayini/README.md) | **2026 dual-gate CURRENT PASS — Gate A 8/8 + Gate B 8/8; 15 repairs; 0 unresolved** | **PASS — synchronized; English re-audit E1 + E2 + E3 + E4 + E5 PASS** |
| [`சபலம்`](stories/sabalam/README.md) | **2026 dual-gate CURRENT PASS — Gate A 7/7 + Gate B 7/7; 6 repairs; 0 unresolved** | **PASS — synchronized; English re-audit E1 + E2 + E3 + E4 + E5 PASS** |
| [`ஆட்டக்காவடி`](stories/aattakkavadi/README.md) | **2026 dual-gate CURRENT PASS — Gate A 8/8 + Gate B 8/8; 7 repairs; 0 unresolved** | **PASS — synchronized; English re-audit E1 + E2 + E3 + E4 + E5 PASS** |
| [`குப்பைத்தொட்டி`](stories/kuppai-thotti/README.md) | **2026 dual-gate CURRENT PASS — Gate A 8/8 + Gate B 8/8; 4 repairs; 0 unresolved** | **PASS — synchronized; English re-audit E1 + E2 + E3 + E4 + E5 PASS** |
| [`சந்தனக்கிண்ணம்`](stories/santhana-kinnam/README.md) | **2026 dual-gate CURRENT PASS — Gate A 10/10 + Gate B 10/10; 3 repairs; 0 unresolved** | **PASS — synchronized; English re-audit E1 + E2 + E3 + E4 + E5 PASS** |
| [`சங்கிலிச்சாமி`](stories/sangilichami/README.md) | **2026 dual-gate CURRENT PASS — Gate A 12/12 + Gate B 12/12; 6 repairs; 0 unresolved** | **PASS — synchronized; English re-audit E1 + E2 + E3 + E4 + E5 PASS** |
| [`கங்கையின் காதல்`](stories/gangaiyin-kadhal/README.md) | **2026 dual-gate CURRENT PASS — Gate A 4/4 + Gate B 4/4; 2 repairs; 0 unresolved** | **PASS — synchronized; English re-audit E1 + E2 + E3 + E4 + E5 PASS** |
| [`தாய்மை`](stories/thaaymai/README.md) | **2026 dual-gate CURRENT PASS — Gate A 11/11 + Gate B 11/11; 42 repairs; 0 unresolved** | **PASS — synchronized; English re-audit E1 + E2 + E3 + E4 + E5 PASS** |
| [`தப்பிவிட்டார்கள்`](stories/thappivittargal/README.md) | **2026 dual-gate CURRENT PASS — Gate A 8/8 + Gate B 8/8; 12 repairs; 0 unresolved** | **PASS — synchronized; English re-audit E1 + E2 + E3 + E4 + E5 PASS** |
...
| [`சீரழித்த சிரிப்பு!`](stories/seerazhitha-sirippu/README.md) | **SOURCE INTAKE COMPLETE — Stage 1 pending; scans 101–102 / printed 91–92** | **not started** |
...
| [`கண்ணடக்கம்`](stories/kannadakkam/README.md) | **2026 dual-gate CURRENT PASS — Gate A 7/7 + Gate B 7/7; 10 repairs; 0 unresolved; scan 166 `வாளை மீனுக்கோ` source-confirmed** | **PASS — synchronized; English re-audit E1 + E2 + E3 + E4 + E5 PASS** |
