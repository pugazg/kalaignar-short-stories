...
- **Periodical source onboarding — CURRENT AUTHORIZED SET CLOSED:** `பனங்குலை` 1977 periodical is **CLOSED / PASS 2/2** as a cross-witness; `சீரழித்த சிரிப்பு!`, `மதுரைச் செலவு`, and `கொன்று வருக!` are **Tamil/source + English CLOSED / PASS**. The 1958 `தேனலைகள்` source remains deferred.
...
| [`கொன்று வருக!`](stories/kondru-varuga/README.md) | **Tamil/source CLOSED / PASS — verified 6/6** | **PASS / CLOSED — E1→E5 complete** |
