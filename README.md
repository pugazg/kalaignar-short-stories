...
- **1953 `நாடும் நாடகமும்` — ACTIVE:** all five body units remain in this repository. Retained work 1 `நாடும் நாடகமும் (ஆசிரியர் பேசுகிறார்)` Batch 1 scans **5–9 / printed 1–5** has Stage 4 **PARTIAL / HOLD**: scans **5–8 VERIFIED**, scan **9 NEEDS-REVIEW**; Stage 4 made **0 additional corrections**. One library/ownership-mark-crossed source span on scan 9 remains physically unresolved after exhaustive image work. Exact next: **resolve or formally disposition that single scan-9 source obstruction**. `தெருக்கூத்து` remains next after this work closes.
