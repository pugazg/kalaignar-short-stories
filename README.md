...
- **1969 `கண்ணடக்கம்` — ACTIVE:** `நெருப்பு` has Stages 1–3 complete for all **14/14** pages; P1+P2 remain **verified 10/10** and P3 awaits only **Stage 4 final source check, scans 21–24 / printed 20–23**. The supplied collection still has an unresolved physical gap at printed pages **31–52**.
