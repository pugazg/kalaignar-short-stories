...
- **1969 `கண்ணடக்கம்` — ACTIVE:** `நெருப்பு` is **Tamil/source PASS / CLOSED**; the 1969 `கண்ணடக்கம்` comparison witness is now **CLOSED / PASS (7/7 scans)** with canonical Tamil/English unchanged. Exact next is **`வேணியின் காதலன்` witness scans 25–31 / printed 24–30**. The supplied collection still has an unresolved physical gap at printed pages **31–52**.
