...
- **Periodical source onboarding — ACTIVE:** `பனங்குலை` 1977 periodical is **CLOSED / PASS 2/2** as a cross-witness; `சீரழித்த சிரிப்பு!` and `மதுரைச் செலவு` are **Tamil/source + English CLOSED / PASS**; `கொன்று வருக!` is **Stage 2 ordinary visual fidelity COMPLETE / PASS 6/6**, with Stage 3 historical-glyph audit next.
