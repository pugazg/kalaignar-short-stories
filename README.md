...
- **1953 `நாடும் நாடகமும்` — ACTIVE:** all five body units remain in this repository. Retained work 1 `நாடும் நாடகமும் (ஆசிரியர் பேசுகிறார்)` Batch 1 scans **5–9 / printed 1–5** now has Stages **1–3 COMPLETE**; Stage 2 made **16 source-proven corrections**, Stage 3 made **0 character-identity corrections / 0 unresolved glyph clusters**, and the scan-9 mark-crossed source span remains unresolved. Exact next: **Stage 4 final independent source check on scans 5–9**. `தெருக்கூத்து` remains next after this work closes.
