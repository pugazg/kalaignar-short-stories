...
- **1956 `தாய்மை` — ACTIVE / EARLIER-WITNESS ANTHOLOGY:** `தாய்மை` **CLOSED 16/16**; `ஆட்டக் காவடி` **CLOSED 11/11**; cross-repo `நடுத்தெரு நாராயணி` **CLOSED / PASS 26/26** with four canonical-recheck candidates retained; active `அரும்பு` witness in `pugazg/kalaignar-novels` is **IN PROGRESS 9/28** through scans **60–68 / printed 58–66**, with **0** canonical changes and **0** open recheck candidates so far. Printed pages **80–81** remain absent. Exact next = scans **69–78 / printed 67–76**.
