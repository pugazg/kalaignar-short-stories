...
- **1953 `நாடும் நாடகமும்` — ACTIVE:** all five body units remain in this repository. Retained work 1 `நாடும் நாடகமும் (ஆசிரியர் பேசுகிறார்)` Batch 1 scans **5–9 / printed 1–5** is now **CLOSED / VERIFIED 5/5** after the word-by-word re-audit and a user-guided targeted scan-9 recheck, with **18 final source-proven corrections**. The former scan-9 hold is resolved; no guessed reconstruction remains. Exact next: **Batch 2 Stage 1 first-pass transcription, scans 10–14 / printed 6–10**. `தெருக்கூத்து` remains next after this work closes.
