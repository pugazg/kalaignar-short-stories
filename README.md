...
- **1953 `நாடும் நாடகமும்` — ACTIVE / INTAKE COMPLETE:** mixed publication registered at [`collections/1953-naadum-naadagamum/`](collections/1953-naadum-naadagamum/README.md). Three short-story blocks are mapped: **2 earlier witnesses + 1 new-canonical candidate (`பெண்கள்`)**. Exact next: `ஆலமரத்துப் புறாக்கள்` witness comparison, scans **52–68 / printed 44–60**.
