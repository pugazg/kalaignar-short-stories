...
- **1953 `நாடும் நாடகமும்` — ACTIVE:** all five body units remain in this repository. Retained work 1 `நாடும் நாடகமும் (ஆசிரியர் பேசுகிறார்)` Batch 1 scans **5–9 / printed 1–5** is **CLOSED UNDER DOCUMENTED SOURCE LIMITATION**: scans **5–8 VERIFIED**; scan **9 BLOCKED only at one physically obliterated span**, with no guessed reconstruction. Exact next: **Batch 2 Stage 1 first-pass transcription, scans 10–14 / printed 6–10**. `தெருக்கூத்து` remains next after this work closes.
