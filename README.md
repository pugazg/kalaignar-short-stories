...
- **1956 `தாய்மை` — ACTIVE / EARLIER-WITNESS ANTHOLOGY:** source registered at [`collections/1956-thaaymai/`](collections/1956-thaaymai/README.md); four works mapped; all four already canonical elsewhere; printed pages **80–81 are absent** from the supplied PDF. Active comparison: `தாய்மை` 1956 witness **12/16 scans** reviewed (scans **7–18 / printed 5–16**); 1956 independently confirms canonical `ஆயிரந்தேர்`; no canonical recheck candidate is open; exact next **scans 19–22 / printed 17–20**.
