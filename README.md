...
- **1953 `நாடும் நாடகமும்` — ACTIVE:** all five body units remain in this repository. Retained work 1 `நாடும் நாடகமும் (ஆசிரியர் பேசுகிறார்)` is **IN PROGRESS**: Batch 1 scans **5–9 / printed 1–5** Stage 1 first-pass **COMPLETE 5/5**, pages `needs-review`. Exact next: **Stage 2 visual text-fidelity audit on scans 5–9**. `தெருக்கூத்து` remains next after this work closes.
