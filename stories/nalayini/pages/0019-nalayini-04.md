...
- 2026 Gate A corrected `கண்ணாடை காட்டினாள்`→`கண்ஜாடை காட்டினாள்`.
- 2026 Gate B corrected `அண்டெடுத்து`→`அணைத்தெடுத்து` after independent `ணை`-family verification.
- `அம்சதூளிகா` and `கற்புக் கரசியின்` were rechecked and retained.
