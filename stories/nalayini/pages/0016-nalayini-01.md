...
- Visual-fidelity review records the long horizontal source rule directly beneath the opening heading `நளாயினி`.
- Printed page number is page furniture and remains excluded from story text.
- Page-ending `கால்` continues mechanically on printed page 8 / scan 17 as `பாகத்துக்குமேல்...`.
- 2026 dual-gate re-audit corrected earlier `கையில் ஒரு கூடையுடன்` to source-proven `தலையிலே ஒரு கூடையுடன்`.
- `வரவிழைந்த`, `சோபிதம்`, and `விசாரத்தைக்` were rechecked against the controlling 1977 scan and retained.
- Gate A source fidelity: PASS for this page. Gate B historical-glyph check: PASS for this page; 0 unresolved.

<!-- மூல ஸ்கேன் பக்கம்: 16; அச்சுப் பக்கம்: 7 -->
