...
Canonical workspace activated from the 1952 **முரசொலி பொங்கல் மலர்** source.
...
- year: **1952**
- physical scans: **8–13**
- printed-page sequence: **32–37**
- scan 14: separate article `திராவிட இலக்கியம்` — boundary witness
...
- Stage 1 first-pass transcription: **COMPLETE 6/6 — historical record retained**
- Stage 2 word-by-word ordinary visual fidelity: **COMPLETE / PASS 6/6**
- Stage-2 physical page remap: **COMPLETE**
- Stage-1 `[…]` clusters: **3 → 0 unresolved**
- current assembly: `sections/kondru-varuga.md`
- Stage-2 record: `STAGE2_BATCH_001.md`
...
## Correct physical page map

- scan 8 / printed 32 — title artwork only;
- scan 9 / printed 33 — illustrated one-sentence opening;
- scan 10 / printed 34 — dense three-column body;
- scan 11 / printed 35 — dense three-column body;
