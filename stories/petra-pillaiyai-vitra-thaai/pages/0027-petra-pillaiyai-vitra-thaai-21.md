...
> Historical-glyph gate: **PASS** — `சுற்றினாள்` / `எண்ணினாள்` decoded from native/high-resolution historical type; final source/visual closure **PASS**. Ordinary source/spacing corrections were rechecked directly against scan 27.
