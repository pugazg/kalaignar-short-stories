...
1. `என்கிறார்களே....` → **`என்கிறார்களே...`** — source dot count.
2. `சாரட்டு வண்டி வந்து நின்றது;` → **`சாரட்டு வண்டி வந்து நின்றது’`** — source-visible closing punctuation; the Stage-2 semicolon was not present.
3. `போய் விடும்... ஹி...ஹி...ஹி!` → **`போய் விடும்...ஹி...ஹி...ஹி!`** — source-visible spacing.
4. `பிரம்மச்சாரி” என்று. தனது` → **`பிரம்மச்சாரி” என்று தனது`** — Stage-2 inserted period removed.

Stage-3 historical-glyph readings `கடன்காரனாம்` (`னா`) and `ஆடைகளை` (`ளை`) were independently rechecked and **CONFIRMED**.

- complete scan-101 text coverage: **PASS**
- illustrated-title / multi-column order: **PASS**
- scan 101→102 continuation `வேதனைச் / சிலையானாள்`: **PASS**
