...
|---:|---:|---|---|---|
| 11 | 10 | story-opening | `needs-review` | **P1 Stage 2 PASS; Stage 3 NEXT** |
| 12 | 11 | story | `needs-review` | **P1 Stage 2 PASS; Stage 3 NEXT** |
| 13 | 12 | story | `needs-review` | **P1 Stage 2 PASS; Stage 3 NEXT** |
| 14 | 13 | story | `needs-review` | **P1 Stage 2 PASS; opening resolved as `விதந்தன்னை`; Stage 3 NEXT** |
| 15 | 14 | story | `needs-review` | **P1 Stage 2 PASS; Stage 3 NEXT** |
...
Next: **P1 Stage 3 historical Tamil glyph audit — scans 11–15 / printed pages 10–14**.