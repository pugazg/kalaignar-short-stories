# Possible Errors for Human Review — கனியும் கணையும்

Persistent human recheck queue; both Story-20 records remain `verified`.
...
| 42→43 | 40→41 | story extends beyond TOC-derived scan 42 | shared ending on scan 43 documented |
