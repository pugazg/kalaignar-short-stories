...
> **Assembled Tamil reading text.** இந்த file `pages/0007-...` முதல் `pages/0022-...` வரை உள்ள audited archival page records-ஐ scan வரிசையில் ஒன்றிணைக்கிறது. இது modernized edition அல்ல. Page-level அச்சு வாசிப்புகள் பாதுகாக்கப்பட்டுள்ளன; தெளிவில்லாத இடங்கள் explicit marker-ஆகவே உள்ளன. Scan 23-ன் `பிழை திருத்தம்.` இந்த உரையில் silently பயன்படுத்தப்படவில்லை. அதற்கான தனி mapping: [`kizhavan-kanavu-errata.md`](kizhavan-kanavu-errata.md).
...
- Unresolved readings are deliberately visible; they are not reconstructed from context or another edition.
