...
English scope is the **story body only: scans 7–22**.
...
- author note;
- scan 23 errata/advertising;
- commercial advertisements;
- salesperson / publisher-printer material below the scan-22 story conclusion;
- back cover.
...
The English archival translation does not silently replace archival page readings with publisher errata. See `ERRATA_NOTES.md`.

## Translation principles

### Fidelity before fluency

Preserve meaning, rhetorical movement, repetition, irony, satire, polemic and emotional intensity. Do not rewrite the story as contemporary English fiction.
...
- retain paragraph/dialogue sequence;
