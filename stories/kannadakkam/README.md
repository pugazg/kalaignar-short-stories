...
Canonical story workspace for **கண்ணடக்கம்**, processed from the 1977 anthology **கலைஞர் கருணாநிதியின் சிறுகதைகள்**.
...
Final current Tamil assembly: [`sections/kannadakkam.md`](sections/kannadakkam.md).

The assembly preserves all seven anthology scan boundaries. Scan 173, which opens `வாழ முடியாதவர்கள்`, is excluded.
