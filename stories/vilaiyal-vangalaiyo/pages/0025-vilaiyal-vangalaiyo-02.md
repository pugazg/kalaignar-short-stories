...
- running title `கருணாநிதி` and printed page number `23` are page furniture and excluded;
- scan 24→25 continuation is preserved: `இனி அந்த வாட்டுப் பயல்` → `இந்த ஊர்திரும்ப மாட்டான்.`;
- internal three-circle divider is retained as structural evidence;
- provisional readings for Stage-2 recheck include:
  - `அபிப் பிராயப்படி`;
  - `தகராறு பண்ணினை`;
  - historical-glyph identities within `நிலைக்கண்ணாடிக்கு` and nearby old-type clusters;
