...
- The title prints `ஆட்டக்காவடி`; the body repeatedly uses the spaced form `ஆட்டக் காவடி`.
- `ஏழெட்டுக் குடுக்கை`, `பக்தியின் பாற்பட்டதல்ல`, and quoted `‘பாவலா’` are visually legible but unusual; they remain in the human recheck queue rather than being normalized.
- The final line continues mechanically onto scan 32 / printed page 23 with `முழுசாகக் காண முடியாத பணம்—நூறு ரூபாய்!...`.
