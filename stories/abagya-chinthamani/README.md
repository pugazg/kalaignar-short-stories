...
Canonical story workspace for **அபாக்ய சிந்தாமணி**, processed from the 1977 anthology **கலைஞர் கருணாநிதியின் சிறுகதைகள்**.
...
Final current Tamil assembly: [`sections/abagya-chinthamani.md`](sections/abagya-chinthamani.md).

The assembly preserves all eight anthology scan boundaries. Scan 189, which opens `பாலைவன ரோஜா`, is excluded.
