...
**COMPLETE / PASS — 9 corrections.**

High-value corrections:

- scan-24 letter continuation restored as source `--பிழைப்பு நடத்த...`; no new opening quote is introduced on scan 26;
- `மாதவி எழுதிய` → `மாதவி யெழுதிய`;
- source `வாசகமே--கோவலன்` punctuation restored;
- `ஒன்றாகிவிடக்கூடிய` → `ஒன்றாகி விடக்கூடிய`;
- `நடந்துகொண்டிருக்கிறான்` → `நடந்து கொண்டிருக்கிறான்`;
- `சிறப்புக்களை` → `சிறப்புக்கள்`;
- `நிகழ்ச்சிகளை—அக்காலத்திற்கேற்ற` → `நிகழ்ச்சிகள்--அக்காலத்திற்கேற்ற`;
- `மல்லி, முல்லை` → `மல்லி முல்லை`;
- `தென்றலாகும் இது;` → `தென்றலாகும் இது!`.

Scan 25 remains excluded non-story matter; scan 27 remains the forward boundary.
