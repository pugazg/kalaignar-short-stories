# English Translation Progress — 1977 Anthology

Controlling source: `TVA_BOK_0064142_கலைஞர்_கருணாநிதியின்_சிறுகதைகள்.pdf`

Translation workflow: `ENGLISH_TRANSLATION_GUIDE.md`

The canonical Tamil source-text audit and visual-fidelity phases are complete for **37 / 37** anthology stories. English is maintained as a separate translation layer and does not replace canonical Tamil.
...
Current post-Tamil English re-audit: **E1 31/37 PASS; E2–E5 not started**. The latest Stories 12–31 E1 batch produced **5 page-anchor/content-boundary repairs + 17 structure-traceability annotation repairs / 0 unresolved**. Cumulative page-anchor/content-boundary repairs: **8**. Next: Story 32 `விஷம் இனிது` E1.
